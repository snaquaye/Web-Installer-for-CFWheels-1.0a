...
<cfscript>
	set(functionName="textField,passwordField,textFieldTag, passwordFieldTag", labelPlacement="before", prependToLabel="<div>", appendToLabel="<br/>", append="</div>");
	set(functionName="radioButtonTag", labelPlacement="after");
</cfscript>